            ...
            actionsList.append(
                ...
                "<div class='col-md-6 action-item' id='action" + nAction + "'>" +
                    ...
                    "<div class='row action-fragment'>" +
                        ...
                        "<div class='col-md-9'>" +
                            "<textarea placeholder='ewe-chromecast:Chromecast ewe:providesAction ewe-chromecast:PlayVideo.\newe-chromecast:PlayVideo ov:video #video#.' rows='4' name='action-rule" + nAction + "' required data-validation-required-message='Please enter a rule for the action.' class='form-control'>" + rule + "</textarea>" +
                        "</div>" +
                    "</div>  <!-- Rule -->" +
